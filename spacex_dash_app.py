...
def get_pie_chart(entered_site):
    ...
    # return the outcomes piechart for a selected site
        ...
        single_df = filtered_df[ filtered_df["Launch Site"] == entered_site ].copy()
        single_df["outcome"] = single_df["class"].astype("str")
        single_df["class"] = 1
        fig = px.pie(single_df,
                     values="class",
                     names ="outcome",
                     title = "Proportion Successful Launches for site " + entered_site)
